...
RUN apt-get install -y python3.8 python3.8-distutils wget ghostscript python3-tk ffmpeg libsm6 libxext6 git
...
RUN pip install itsdangerous==2.0.1 Jinja2==3.0.3
